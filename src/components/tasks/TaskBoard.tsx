        ...
        {statusColumns.map((column) => {
          ...
          return (
            ...
            >
              ...
              {/* Task Cards */}
              <div 
                className="space-y-3 min-h-[400px] p-2 rounded-lg border-2 border-dashed border-border/50 transition-colors"
                onDragOver={(e) => e.preventDefault()}
                onDrop={(e) => {
                  e.preventDefault();
                  // Handle task status change
                  console.log(`Move task ${draggedTask} to ${column.id}`);
                }}
              >
