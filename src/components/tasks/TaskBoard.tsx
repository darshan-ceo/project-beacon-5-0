  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-foreground">Task Board</h2>
        <div className="flex items-center gap-2 sm:gap-4 text-[11px] sm:text-xs md:text-sm text-muted-foreground">
      ...
      <div className="overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0">
        <div className="grid grid-cols-5 gap-3 md:gap-6 min-w-[900px] md:min-w-0">
