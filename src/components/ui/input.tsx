  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full rounded-beacon-md border border-input bg-background px-3 py-2 text-[14px] leading-relaxed transition-all duration-200",
          "placeholder:text-muted-foreground placeholder:font-normal placeholder:text-[14px]",
          "hover:bg-muted/30",
