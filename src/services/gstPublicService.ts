...
class GSTPublicService {
  ...
  /**
   * Map GST state code (e.g., "24") to state name (e.g., "Gujarat")
   */
  ...
  private mapAddressFormat(apiAddr: any): GSTAddress {
    ...
    // Convert state code (e.g., "24") to state name (e.g., "Gujarat")
    const stateName = this.getStateNameFromCode(apiAddr.stcd || '');
